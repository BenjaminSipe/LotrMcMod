...
public class LOTREntityDaleMan extends LOTREntityMan {
   ...
   public LOTREntityDaleMan(World world) {
      ...
      this.field_70714_bg.func_75776_a(2, this.createDaleAttackAI());
      this.field_70714_bg.func_75776_a(3, new LOTREntityAIFollowHiringPlayer(this));
      this.field_70714_bg.func_75776_a(4, new EntityAIOpenDoor(this, true));
      this.field_70714_bg.func_75776_a(5, new EntityAIWander(this, 1.0D));
      this.field_70714_bg.func_75776_a(6, new LOTREntityAIEat(this, LOTRFoods.DALE, 8000));
      this.field_70714_bg.func_75776_a(6, new LOTREntityAIDrink(this, LOTRFoods.DALE_DRINK, 8000));
   ...
   public void setupNPCName() {
      this.familyInfo.setName(LOTRNames.getDalishName(this.field_70146_Z, this.familyInfo.isMale()));
   }
   ...
   public String getNPCFormattedName(String npcName, String entityName) {
      return this.getClass() == LOTREntityDaleMan.class ? StatCollector.func_74837_a("entity.lotr.DaleMan.entityName", new Object[]{npcName}) : super.getNPCFormattedName(npcName, entityName);
   }
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      return this.isFriendlyAndAligned(entityplayer) ? "dale/man/friendly" : "dale/man/hostile";
   }
   ...
   static {
      weapons = new ItemStack[]{new ItemStack(LOTRMod.daggerDale), new ItemStack(LOTRMod.daggerIron), new ItemStack(LOTRMod.daggerBronze), new ItemStack(Items.field_151036_c), new ItemStack(LOTRMod.axeBronze), new ItemStack(Items.field_151049_t)};
   }
}
