...
public class LOTRAlignmentValues {
   ...
   public static final LOTRAlignmentValues.AlignmentBonus MARRIAGE_BONUS = new LOTRAlignmentValues.AlignmentBonus(5.0F, "lotr.alignment.marriage");
   public static final LOTRAlignmentValues.AlignmentBonus FANGORN_TREE_PENALTY = new LOTRAlignmentValues.AlignmentBonus(-1.0F, "lotr.alignment.cutFangornTree");
   public static final LOTRAlignmentValues.AlignmentBonus ROHAN_HORSE_PENALTY = new LOTRAlignmentValues.AlignmentBonus(-1.0F, "lotr.alignment.killRohanHorse");
   public static final LOTRAlignmentValues.AlignmentBonus VINEYARD_STEAL_PENALTY = new LOTRAlignmentValues.AlignmentBonus(-1.0F, "lotr.alignment.vineyardSteal");
   public static final LOTRAlignmentValues.AlignmentBonus PICKPOCKET_PENALTY = new LOTRAlignmentValues.AlignmentBonus(-1.0F, "lotr.alignment.pickpocket");
   ...
   public static LOTRAlignmentValues.AlignmentBonus createMiniquestBonus(float alignment) {
      return new LOTRAlignmentValues.AlignmentBonus(alignment, "lotr.alignment.miniQuest");
   }

   public static LOTRAlignmentValues.AlignmentBonus createPledgePenalty(float alignment) {
      return new LOTRAlignmentValues.AlignmentBonus(alignment, "lotr.alignment.breakPledge");
   }
   ...
   private static String formatAlignForDisplay(float alignment, DecimalFormat dFormat, boolean prefixPlus) {
      ...
      String s = dFormat.format((double)alignment);
   ...
   private static DecimalFormat setupDecimalFormat(DecimalFormat dFormat) {
      ...
      String decimalSeparator = StatCollector.func_74838_a("lotr.alignment.decimal_separator_char");
      if (decimalSeparator.length() == 1) {
         decimalSeparatorChar = decimalSeparator.charAt(0);
      }

      String groupSeparator = StatCollector.func_74838_a("lotr.alignment.group_separator_char");
   ...
   public static void notifyAlignmentNotHighEnough(EntityPlayer entityplayer, float alignmentRequired, LOTRFaction faction) {
      IChatComponent componentAlignReq = new ChatComponentText(formatAlignForDisplay(alignmentRequired));
      componentAlignReq.func_150256_b().func_150238_a(EnumChatFormatting.YELLOW);
      entityplayer.func_145747_a(new ChatComponentTranslation("chat.lotr.insufficientAlignment", new Object[]{componentAlignReq, faction.factionName()}));
   }
   ...
   public static void notifyAlignmentNotHighEnough(EntityPlayer entityplayer, float alignmentRequired, LOTRFaction faction1, LOTRFaction faction2) {
      IChatComponent componentAlignReq = new ChatComponentText(formatAlignForDisplay(alignmentRequired));
      componentAlignReq.func_150256_b().func_150238_a(EnumChatFormatting.YELLOW);
      entityplayer.func_145747_a(new ChatComponentTranslation("chat.lotr.insufficientAlignment2", new Object[]{componentAlignReq, faction1.factionName(), faction2.factionName()}));
   }
   ...
   public static void notifyAlignmentNotHighEnough(EntityPlayer entityplayer, float alignmentRequired, LOTRFaction faction1, LOTRFaction faction2, LOTRFaction faction3) {
      IChatComponent componentAlignReq = new ChatComponentText(formatAlignForDisplay(alignmentRequired));
      componentAlignReq.func_150256_b().func_150238_a(EnumChatFormatting.YELLOW);
      entityplayer.func_145747_a(new ChatComponentTranslation("chat.lotr.insufficientAlignment3", new Object[]{componentAlignReq, faction1.factionName(), faction2.factionName(), faction3.factionName()}));
   }

   public static void notifyMiniQuestsNeeded(EntityPlayer entityplayer, LOTRFaction faction) {
      entityplayer.func_145747_a(new ChatComponentTranslation("chat.lotr.requireMiniQuest", new Object[]{faction.factionName()}));
   }
   ...
   public static class AlignmentBonus {
      ...
      public static float scalePenalty(float penalty, float alignment) {
         if (alignment > 0.0F && penalty < 0.0F) {
            ...
            factor = MathHelper.func_76131_a(factor, 1.0F, 20.0F);
            penalty *= factor;
         }
