...
public class LOTRWorldGenGondorTownWall extends LOTRWorldGenGondorStructure {
   ...
   public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
      ...
      for(int i1 = this.xMin; i1 <= this.xMax; ++i1) {
         ...
         int i3;
         for(i3 = 1; (i3 >= 0 || !this.isOpaque(world, i1, i3, k1)) && this.getY(i3) >= 0; --i3) {
            this.setBlockAndMetadata(world, i1, i3, k1, this.rockSlabDoubleBlock, this.rockSlabDoubleMeta);
            this.setGrassToDirt(world, i1, i3 - 1, k1);
         }

         for(i3 = 2; i3 <= 3; ++i3) {
            this.setBlockAndMetadata(world, i1, i3, k1, this.brickBlock, this.brickMeta);
         }
