...
public class LOTRBlockSlab extends LOTRBlockSlabBase {
   ...
   public IIcon func_149691_a(int i, int j) {
      j &= 7;
      if (j == 0) {
         return LOTRMod.smoothStone.func_149691_a(i, 0);
      } else if (j == 1) {
         return LOTRMod.brick.func_149691_a(i, 0);
      } else if (j == 2) {
         return LOTRMod.smoothStone.func_149691_a(i, 1);
      } else if (j == 3) {
         ...
         return j == 7 ? LOTRMod.brick.func_149691_a(i, 6) : super.func_149691_a(i, j);
      }
   }
