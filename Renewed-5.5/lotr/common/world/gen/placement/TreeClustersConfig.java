...
public class TreeClustersConfig implements IPlacementConfig {
   public static final Codec CODEC = RecordCodecBuilder.create((instance) -> {
      return instance.group(Codec.INT.fieldOf("count").orElse(0).forGetter((config) -> {
         return config.count;
      }), Codec.FLOAT.fieldOf("extra_chance").orElse(0.1F).forGetter((config) -> {
         return config.extraChance;
      }), Codec.INT.fieldOf("extra_count").orElse(1).forGetter((config) -> {
         return config.extraCount;
      }), Codec.INT.fieldOf("cluster_scale").orElse(0).forGetter((config) -> {
         return config.clusterScale;
      }), Codec.INT.fieldOf("cluster_chance").orElse(-1).forGetter((config) -> {
         return config.clusterChance;
      }), Codec.INT.fieldOf("cluster_extra_count").orElse(6).forGetter((config) -> {
         return config.clusterExtraCount;
      }), Codec.INT.fieldOf("cluster_random_extra_count").orElse(4).forGetter((config) -> {
         return config.clusterRandomExtraCount;
      }), Codec.INT.fieldOf("layer_limit").orElse(-1).forGetter((config) -> {
         return config.layerLimit;
      }), Codec.BOOL.fieldOf("is_layer_upper_limit").orElse(false).forGetter((config) -> {
         return config.isLayerUpperLimit;
      })).apply(instance, TreeClustersConfig::new);
   });
