...
public class LOTRPacketHandler {
   ...
   public static TargetPoint nearEntity(Entity entity, double range) {
      return new TargetPoint(entity.field_71093_bK, entity.field_70165_t, entity.field_70121_D.field_72338_b, entity.field_70161_v, range);
   }
