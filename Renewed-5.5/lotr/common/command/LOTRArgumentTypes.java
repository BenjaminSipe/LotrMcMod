...
public class LOTRArgumentTypes {
   ...
   private static void register(String name, Class cls, IArgumentSerializer serializer) {
      ...
      ArgumentTypes.func_218136_a(namespacedName, cls, serializer);
   }
   ...
   protected static LogicalSide getSafeSideToUse() {
      LogicalSide safeSide = ServerLifecycleHooks.getCurrentServer() == null && LOTRMod.PROXY.isClient() ? LogicalSide.CLIENT : LogicalSide.SERVER;
      return safeSide;
   }
}
