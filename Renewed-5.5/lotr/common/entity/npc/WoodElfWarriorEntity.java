...
public class WoodElfWarriorEntity extends WoodElfEntity {
   ...
   public static MutableAttribute regAttrs() {
      return WoodElfEntity.regAttrs().func_233815_a_(Attributes.field_233819_b_, 24.0D);
   }
   ...
   public ILivingEntityData func_213386_a(IServerWorld sw, DifficultyInstance diff, SpawnReason reason, ILivingEntityData spawnData, CompoundNBT dataTag) {
      ...
      this.func_184201_a(EquipmentSlotType.FEET, new ItemStack((IItemProvider)LOTRItems.WOOD_ELVEN_BOOTS.get()));
      this.func_184201_a(EquipmentSlotType.LEGS, new ItemStack((IItemProvider)LOTRItems.WOOD_ELVEN_LEGGINGS.get()));
      this.func_184201_a(EquipmentSlotType.CHEST, new ItemStack((IItemProvider)LOTRItems.WOOD_ELVEN_CHESTPLATE.get()));
      if (this.field_70146_Z.nextInt(10) != 0) {
         this.func_184201_a(EquipmentSlotType.HEAD, new ItemStack((IItemProvider)LOTRItems.WOOD_ELVEN_HELMET.get()));
      }
