...
public class LOTRWorldGenGulfTower extends LOTRWorldGenGulfStructure {
   ...
   public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
      ...
      for(k1 = 0; k1 < i1; ++k1) {
         LOTREntityGulfHaradrim warrior = random.nextInt(3) == 0 ? new LOTREntityGulfHaradArcher(world) : new LOTREntityGulfHaradWarrior(world);
         ((LOTREntityGulfHaradrim)warrior).spawnRidingHorse = false;
         this.spawnNPCAndSetHome((EntityCreature)warrior, world, 0, 14, 0, 8);
      }
