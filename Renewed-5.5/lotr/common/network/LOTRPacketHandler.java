...
public class LOTRPacketHandler {
   ...
   public static void register() {
      CHANNEL = NetworkRegistry.newSimpleChannel(new ResourceLocation("lotr", "main"), () -> {
         return "11";
      }, "11"::equals, "11"::equals);
      int id = 0;
      int id = id + 1;
   ...
   public static void sendToDimensionWorld(Object msg, World world) {
      sendToDimension(msg, world.func_234923_W_());
   }
   ...
   public static void sendToAllExcept(Object msg, ServerPlayerEntity player) {
      Iterator var2 = player.field_71133_b.func_184103_al().func_181057_v().iterator();

      while(var2.hasNext()) {
         ServerPlayerEntity otherPlayer = (ServerPlayerEntity)var2.next();
         if (!player.func_110124_au().equals(otherPlayer.func_110124_au())) {
