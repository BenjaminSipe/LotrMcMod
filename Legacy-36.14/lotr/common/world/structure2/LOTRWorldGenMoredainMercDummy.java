...
public class LOTRWorldGenMoredainMercDummy extends LOTRWorldGenStructureBase2 {
   ...
   public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
         ...
         for(int i1 = -1; i1 <= 1; ++i1) {
            for(int k1 = -1; k1 <= 1; ++k1) {
               ...
               for(int j2 = j1 + 1; j2 <= j1 + 3; ++j2) {
                  if (this.isOpaque(world, i1, j2, k1)) {
                     return false;
                  }
               }
            }
      ...
      this.setBlockAndMetadata(world, 0, 2, 0, Blocks.field_150325_L, 12);
      this.placeSkull(world, random, 0, 3, 0);
      this.setBlockAndMetadata(world, -1, 2, 0, Blocks.field_150442_at, 1);
      this.setBlockAndMetadata(world, 1, 2, 0, Blocks.field_150442_at, 2);
      return true;
   }
}
