...
public class LOTRParticles {
   ...
   static {
      ...
      WATERFALL = PARTICLES.register("waterfall", () -> {
         return new BasicParticleType(false);
      });
      BLUE_ELVEN_GLOW = PARTICLES.register("blue_elven_glow", () -> {
         return new BasicParticleType(false);
      });
      GREEN_ELVEN_GLOW = PARTICLES.register("green_elven_glow", () -> {
         return new BasicParticleType(false);
      });
      GOLD_ELVEN_GLOW = PARTICLES.register("gold_elven_glow", () -> {
         return new BasicParticleType(false);
      });
      SILVER_ELVEN_GLOW = PARTICLES.register("silver_elven_glow", () -> {
         return new BasicParticleType(false);
      });
      MALLORN_LEAF = PARTICLES.register("mallorn_leaf", () -> {
         return new BasicParticleType(false);
      });
      MIRK_OAK_LEAF = PARTICLES.register("mirk_oak_leaf", () -> {
         return new BasicParticleType(false);
      });
      GREEN_OAK_LEAF = PARTICLES.register("green_oak_leaf", () -> {
         return new BasicParticleType(false);
      });
      RED_OAK_LEAF = PARTICLES.register("red_oak_leaf", () -> {
         return new BasicParticleType(false);
      });
      GLITTER = PARTICLES.register("glitter", () -> {
         return new BasicParticleType(false);
      });
      RAIN = PARTICLES.register("rain", () -> {
         return new BasicParticleType(false);
      });
      DRIPPING_WATER = PARTICLES.register("dripping_water", () -> {
         return new BasicParticleType(false);
      });
      FALLING_WATER = PARTICLES.register("falling_water", () -> {
         return new BasicParticleType(false);
      });
      SPLASH = PARTICLES.register("splash", () -> {
         return new BasicParticleType(false);
      });
      WHITE_SMOKE = PARTICLES.register("white_smoke", () -> {
         return new BasicParticleType(false);
      });
      MORGUL_WATER_EFFECT = PARTICLES.register("morgul_water_effect", () -> {
         return new BasicParticleType(false);
      });
      MIRKWOOD_WATER_EFFECT = PARTICLES.register("mirkwood_water_effect", () -> {
         return new BasicParticleType(false);
      });
      NPC_SPEECH = PARTICLES.register("npc_speech", () -> {
         return new BasicParticleType(false);
      });
      NPC_QUESTION = PARTICLES.register("npc_question", () -> {
         return new BasicParticleType(false);
      });
      NPC_EXCLAMATION = PARTICLES.register("npc_exclamation", () -> {
         return new BasicParticleType(false);
      });
      CULUMALDA_POLLEN = PARTICLES.register("culumalda_pollen", () -> {
         return new BasicParticleType(false);
      });
      CULUMALD = PARTICLES.register("culumald", () -> {
         return new BasicParticleType(false);
      });
   }
}
