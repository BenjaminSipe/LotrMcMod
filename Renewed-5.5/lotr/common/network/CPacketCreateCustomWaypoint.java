      ...
      if (!world.func_82736_K().func_223586_b(LOTRGameRules.CUSTOM_WAYPOINT_CREATION)) {
         ...
         if (waypointName.isEmpty()) {
            ...
            if (waypointPos == null) {
               ...
               if (waypointPos.func_218138_a(playerPos, false) >= 64.0D) {
                  ...
                  LOTRUtil.sendMessage(player, new TranslationTextComponent("chat.lotr.cwp.create", new Object[]{waypointName, ftData.getNumCustomWaypoints(), ftData.getMaxCustomWaypoints()}));
