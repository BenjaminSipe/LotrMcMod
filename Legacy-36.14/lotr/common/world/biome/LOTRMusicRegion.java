...
public enum LOTRMusicRegion {
   ...
   public LOTRMusicRegion.Sub getSubregion(String s) {
      if (s != null && !this.subregions.contains(s)) {
         this.subregions.add(s);
      }

      return new LOTRMusicRegion.Sub(this, s);
   }

   public LOTRMusicRegion.Sub getWithoutSub() {
      return new LOTRMusicRegion.Sub(this, (String)null);
   }
   ...
   public static LOTRMusicRegion forName(String s) {
      LOTRMusicRegion[] var1 = values();
      int var2 = var1.length;

      for(int var3 = 0; var3 < var2; ++var3) {
         LOTRMusicRegion r = var1[var3];
   ...
   public static class Sub extends Pair {
