...
public abstract class LOTREntityNearHaradrimBase extends LOTREntityMan {
   public LOTREntityNearHaradrimBase(World world) {
      ...
      this.field_70714_bg.func_75776_a(6, new LOTREntityAIEat(this, this.getHaradrimFoods(), 8000));
      this.field_70714_bg.func_75776_a(6, new LOTREntityAIDrink(this, this.getHaradrimDrinks(), 6000));
   ...
   public void func_70037_a(NBTTagCompound nbt) {
      ...
      if (nbt.func_74764_b("HaradrimName")) {
         this.familyInfo.setName(nbt.func_74779_i("HaradrimName"));
      }
