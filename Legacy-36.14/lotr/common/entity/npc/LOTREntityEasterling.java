...
public class LOTREntityEasterling extends LOTREntityMan {
   ...
   public LOTREntityEasterling(World world) {
      ...
      this.field_70714_bg.func_75776_a(2, this.createEasterlingAttackAI());
      this.field_70714_bg.func_75776_a(3, new LOTREntityAIFollowHiringPlayer(this));
      this.field_70714_bg.func_75776_a(4, new EntityAIOpenDoor(this, true));
      this.field_70714_bg.func_75776_a(5, new EntityAIWander(this, 1.0D));
      this.field_70714_bg.func_75776_a(6, new LOTREntityAIEat(this, LOTRFoods.RHUN, 8000));
      this.field_70714_bg.func_75776_a(6, new LOTREntityAIDrink(this, LOTRFoods.RHUN_DRINK, 8000));
   ...
   public void setupNPCName() {
      this.familyInfo.setName(LOTRNames.getRhunicName(this.field_70146_Z, this.familyInfo.isMale()));
   }
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      if (this.isDrunkard()) {
         ...
         return this.isFriendlyAndAligned(entityplayer) ? "rhun/man/friendly" : "rhun/man/hostile";
      }
   }
   ...
   static {
      weapons = new ItemStack[]{new ItemStack(LOTRMod.daggerRhun), new ItemStack(LOTRMod.daggerIron), new ItemStack(LOTRMod.daggerBronze)};
   }
}
