...
public class UmbarArcherEntity extends UmbarSoldierEntity {
   public UmbarArcherEntity(EntityType type, World w) {
      super(type, w);
   ...
   public ILivingEntityData func_213386_a(IServerWorld sw, DifficultyInstance diff, SpawnReason reason, ILivingEntityData spawnData, CompoundNBT dataTag) {
      ...
      this.npcItemsInv.setMeleeWeapon(new ItemStack((IItemProvider)LOTRItems.UMBAR_DAGGER.get()));
