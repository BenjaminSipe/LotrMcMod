...
public enum ConnectedTextureElement {
   ...
   private static final Map ELEMENTS_BY_NAME = LOTRUtil.createKeyedEnumMap(values(), (elem) -> {
   ...
   public static final Map ALL_COMBINATIONS_WITHOUT_BASE = (Map)Util.func_200696_a(new HashMap(), (map) -> {
   ...
   public static final Map ALL_COMBINATIONS_WITH_BASE = (Map)Util.func_200696_a(new HashMap(), (map) -> {
   ...
   private static final Comparator COMPARATOR = (e1, e2) -> {
