...
public class LOTRTitle {
   public static List allTitles = new ArrayList();
   ...
   private LOTRTitle.TitleType titleType;
   private UUID[] uuids;
   private List alignmentFactions;
   ...
   public LOTRTitle(String s) {
      this.isHidden = false;
      this.titleType = LOTRTitle.TitleType.STARTER;
   ...
   public LOTRTitle(String s, LOTRAchievement ach) {
      ...
      this.titleType = LOTRTitle.TitleType.ACHIEVEMENT;
   ...
   public LOTRTitle(LOTRFactionRank rank, boolean fem) {
      ...
      this.titleType = LOTRTitle.TitleType.RANK;
      this.titleRank = rank;
      this.isFeminineRank = fem;
   }

   public LOTRTitle setPlayerExclusive(UUID... players) {
      this.titleType = LOTRTitle.TitleType.PLAYER_EXCLUSIVE;
      this.uuids = players;
      this.isHidden = true;
      return this;
   }
   ...
   public LOTRTitle setPlayerExclusive(UUID[]... playersArrays) {
      ...
      UUID[][] var3 = playersArrays;
      int var4 = playersArrays.length;

      for(int var5 = 0; var5 < var4; ++var5) {
         UUID[] players = var3[var5];
   ...
   public LOTRTitle setShieldExclusive(LOTRShields... shields) {
      List allPlayers = new ArrayList();
      LOTRShields[] var3 = shields;
      int var4 = shields.length;

      for(int var5 = 0; var5 < var4; ++var5) {
         LOTRShields shield = var3[var5];
   ...
   public LOTRTitle setMultiAlignment(float alignment, List factions) {
      this.titleType = LOTRTitle.TitleType.ALIGNMENT;
   ...
   public static LOTRTitle forName(String name) {
      Iterator var1 = allTitles.iterator();
      ...
      do {
         ...
         title = (LOTRTitle)var1.next();
      } while(!title.getTitleName().equals(name));
   ...
   public String getUntranslatedName(EntityPlayer entityplayer) {
      ...
      } else if (this.titleType == LOTRTitle.TitleType.RANK) {
   ...
   public String getDisplayName(EntityPlayer entityplayer) {
      if (this.titleType == LOTRTitle.TitleType.RANK) {
         return this.isFeminineRank ? this.titleRank.getDisplayFullNameFem() : this.titleRank.getDisplayFullName();
      } else {
         return StatCollector.func_74838_a(this.getUntranslatedName(entityplayer));
      }
   }
   ...
   public String getDescription(EntityPlayer entityplayer) {
      ...
      case ALIGNMENT:
         alignLevel = LOTRAlignmentValues.formatAlignForDisplay(this.alignmentRequired);
         if (this.anyAlignment) {
            return StatCollector.func_74837_a("lotr.titles.unlock.alignment.any", new Object[]{alignLevel});
         } else {
            String s = "";
            if (this.alignmentFactions.size() > 1) {
               for(int i = 0; i < this.alignmentFactions.size(); ++i) {
                  LOTRFaction f = (LOTRFaction)this.alignmentFactions.get(i);
                  if (i > 0) {
                     s = s + " / ";
                  }
               ...
               LOTRFaction f = (LOTRFaction)this.alignmentFactions.get(0);
               s = f.factionName();
            }

            boolean requirePledge = this.isAlignmentGreaterThanOrEqualToAllFactionPledges() && LOTRConfig.areStrictFactionTitleRequirementsEnabled(entityplayer.field_70170_p);
            if (requirePledge) {
               return StatCollector.func_74837_a("lotr.titles.unlock.alignment.pledge", new Object[]{s, alignLevel});
            }

            return StatCollector.func_74837_a("lotr.titles.unlock.alignment", new Object[]{s, alignLevel});
         }
      case ACHIEVEMENT:
         return this.titleAchievement.getDescription(entityplayer);
      case RANK:
         alignLevel = LOTRAlignmentValues.formatAlignForDisplay(this.titleRank.alignment);
         boolean requirePledge = this.titleRank.isAbovePledgeRank() || this.titleRank.isPledgeRank() && LOTRConfig.areStrictFactionTitleRequirementsEnabled(entityplayer.field_70170_p);
         if (requirePledge) {
            return StatCollector.func_74837_a("lotr.titles.unlock.alignment.pledge", new Object[]{this.titleRank.fac.factionName(), alignLevel});
         }

         return StatCollector.func_74837_a("lotr.titles.unlock.alignment", new Object[]{this.titleRank.fac.factionName(), alignLevel});
      default:
   ...
   private boolean isAlignmentGreaterThanOrEqualToAllFactionPledges() {
      if (this.titleType == LOTRTitle.TitleType.ALIGNMENT && !this.anyAlignment) {
         Iterator var1 = this.alignmentFactions.iterator();
         ...
         do {
            ...
            fac = (LOTRFaction)var1.next();
         } while(this.alignmentRequired >= fac.getPledgeAlignment());
   ...
   public boolean isFeminineRank() {
      return this.titleType == LOTRTitle.TitleType.RANK && this.isFeminineRank;
   }

   public static Comparator createTitleSorter(final EntityPlayer entityplayer) {
   ...
   public boolean canPlayerUse(EntityPlayer entityplayer) {
      ...
      case STARTER:
         return true;
      case PLAYER_EXCLUSIVE:
         UUID[] var6 = this.uuids;
         int var8 = var6.length;

         for(int var10 = 0; var10 < var8; ++var10) {
            UUID player = var6[var10];
            if (entityplayer.func_110124_au().equals(player)) {
               return true;
            }
         }
         ...
         return false;
      case ALIGNMENT:
         pd = LOTRLevelData.getData(entityplayer);
         boolean requirePledge = this.isAlignmentGreaterThanOrEqualToAllFactionPledges() && LOTRConfig.areStrictFactionTitleRequirementsEnabled(entityplayer.field_70170_p);
         Iterator var9 = this.alignmentFactions.iterator();
         ...
         do {
            do {
               ...
               f = (LOTRFaction)var9.next();
            } while(pd.getAlignment(f) < this.alignmentRequired);
         } while(requirePledge && !pd.isPledgedTo(f));
      ...
      case RANK:
         ...
         if (align < this.titleRank.alignment) {
            ...
            boolean requirePledge = this.titleRank.isAbovePledgeRank() || this.titleRank.isPledgeRank() && LOTRConfig.areStrictFactionTitleRequirementsEnabled(entityplayer.field_70170_p);
            if (requirePledge && !pd.isPledgedTo(fac)) {
               return false;
            }
   ...
   public static void createTitles() {
      ...
      creator = (new LOTRTitle("creator")).setPlayerExclusive();
   ...
   public static class PlayerTitle {
      ...
      public PlayerTitle(LOTRTitle title) {
         this(title, (EnumChatFormatting)null);
      }

      public PlayerTitle(LOTRTitle title, EnumChatFormatting color) {
         this.theTitle = title;
         if (color == null || !color.func_96302_c()) {
      ...
      public IChatComponent getFullTitleComponent(EntityPlayer entityplayer) {
         IChatComponent component = (new ChatComponentText("[")).func_150257_a(new ChatComponentTranslation(this.theTitle.getUntranslatedName(entityplayer), new Object[0])).func_150258_a("]").func_150258_a(" ");
         component.func_150256_b().func_150238_a(this.theColor);
         return component;
      }

      public String getFormattedTitle(EntityPlayer entityplayer) {
         return this.getFullTitleComponent(entityplayer).func_150254_d();
      }
      ...
      public static void writeNullableTitle(ByteBuf data, LOTRTitle.PlayerTitle title) {
         if (title != null) {
            data.writeShort(title.getTitle().titleID);
            data.writeByte(title.getColor().func_96298_a());
         } else {
            data.writeShort(-1);
         }
      ...
      public static LOTRTitle.PlayerTitle readNullableTitle(ByteBuf data) {
         ...
         if (titleID >= 0) {
            ...
            if (title != null && color != null) {
               return new LOTRTitle.PlayerTitle(title, color);
            }
         }
