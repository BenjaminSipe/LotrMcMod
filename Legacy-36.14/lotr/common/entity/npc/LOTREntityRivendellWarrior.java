...
public class LOTREntityRivendellWarrior extends LOTREntityRivendellElf {
   ...
   public IEntityLivingData func_110161_a(IEntityLivingData data) {
      ...
      if (this.field_70146_Z.nextInt(10) != 0) {
         this.func_70062_b(4, new ItemStack(LOTRMod.helmetRivendell));
      }
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      if (this.isFriendlyAndAligned(entityplayer)) {
         return this.hiredNPCInfo.getHiringPlayer() == entityplayer ? "rivendell/elf/hired" : "rivendell/warrior/friendly";
      } else {
