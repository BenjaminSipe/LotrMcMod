...
public class SPacketNPCEntitySettings {
   ...
   public SPacketNPCEntitySettings(NPCEntitySettingsMap settings) {
      this.npcEntitySettingsMap = settings;
   }
   ...
   public static void handle(SPacketNPCEntitySettings packet, Supplier context) {
      NPCEntitySettingsManager.clientInstance().loadClientEntitySettingsFromServer(Minecraft.func_71410_x().func_195551_G(), packet.npcEntitySettingsMap);
