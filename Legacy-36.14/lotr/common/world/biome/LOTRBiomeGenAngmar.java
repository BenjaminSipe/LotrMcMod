...
public class LOTRBiomeGenAngmar extends LOTRBiome {
   ...
   public LOTRBiomeGenAngmar(int i, boolean major) {
      ...
      this.field_76762_K.add(new SpawnListEntry(LOTREntityDeer.class, 2, 4, 8));
      ...
      LOTRBiomeSpawnList.SpawnListContainer[] var10001 = new LOTRBiomeSpawnList.SpawnListContainer[7];
      LOTRBiomeSpawnList var10004 = this.npcSpawnList;
      var10001[0] = LOTRBiomeSpawnList.entry(LOTRSpawnList.ANGMAR_ORCS, 30);
      var10004 = this.npcSpawnList;
      var10001[1] = LOTRBiomeSpawnList.entry(LOTRSpawnList.ANGMAR_BOMBARDIERS, 5);
      var10004 = this.npcSpawnList;
      var10001[2] = LOTRBiomeSpawnList.entry(LOTRSpawnList.ANGMAR_WARGS, 30);
      var10004 = this.npcSpawnList;
      var10001[3] = LOTRBiomeSpawnList.entry(LOTRSpawnList.TROLLS, 30);
      var10004 = this.npcSpawnList;
      var10001[4] = LOTRBiomeSpawnList.entry(LOTRSpawnList.HILL_TROLLS, 20);
      var10004 = this.npcSpawnList;
      var10001[5] = LOTRBiomeSpawnList.entry(LOTRSpawnList.SNOW_TROLLS, 5);
      var10004 = this.npcSpawnList;
      var10001[6] = LOTRBiomeSpawnList.entry(LOTRSpawnList.ANGMAR_HILLMEN, 20);
      var10000.add(var10001);
      var10000 = this.npcSpawnList.newFactionList(2, 0.0F);
   ...
   public void func_76728_a(World world, Random random, int i, int k) {
      ...
      for(i1 = 0; i1 < 4; ++i1) {
         ...
         if (j1 > 80) {
            this.decorator.genTree(world, random, k1, j1, k1);
         }
      }
