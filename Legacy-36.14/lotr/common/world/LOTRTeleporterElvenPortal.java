...
public class LOTRTeleporterElvenPortal extends Teleporter {
               ...
               for(int j1 = this.theWorld.func_72940_L() - 1; j1 >= 0; --j1) {
                  ...
                  for(int i2 = i1 - 1; i2 <= i1 + 1; ++i2) {
                     for(int k2 = k1 - 1; k2 <= k1 + 1; ++k2) {
                        if (this.theWorld.func_147439_a(i2, j1, k2) != LOTRMod.elvenPortal) {
                           portalHere = false;
                        }
                     }
                  }
   ...
   public boolean func_85188_a(Entity entity) {
      ...
      for(i1 = -2; i1 <= 2; ++i1) {
         for(k1 = -2; k1 <= 2; ++k1) {
            for(j1 = generateDirtBelow ? -1 : 0; j1 <= 2; ++j1) {
               i2 = i1 + i1;
               k2 = actualPosY + j1;
               j2 = actualPosZ + k1;
               if (j1 > 0) {
                  ...
                  this.theWorld.func_147465_d(i2, k2, j2, Blocks.field_150346_d, 0, 2);
               } else {
                  boolean isFrame = i1 == -2 || i1 == 2 || k1 == -2 || k1 == 2;
                  this.theWorld.func_147465_d(i2, k2, j2, isFrame ? LOTRMod.quenditeGrass : LOTRMod.elvenPortal, 0, 2);
               }
            }
         }
      }
      ...
      for(i1 = -3; i1 <= 3; ++i1) {
         for(k1 = -3; k1 <= 3; ++k1) {
            for(j1 = generateDirtBelow ? -2 : -1; j1 <= 3; ++j1) {
               i2 = i1 + i1;
               k2 = actualPosY + j1;
               j2 = actualPosZ + k1;
