...
public class LOTRConfig {
   ...
   public static List getConfigElements() {
      List list = new ArrayList();
      Iterator var1 = allCategories.iterator();

      while(var1.hasNext()) {
         ConfigCategory category = (ConfigCategory)var1.next();
   ...
   public static boolean isFellowshipCreationEnabled(World world) {
      return !world.field_72995_K ? enableFellowshipCreation : LOTRLevelData.clientside_thisServer_fellowshipCreation;
   }

   public static int getFellowshipMaxSize(World world) {
      return !world.field_72995_K ? fellowshipMaxSize : LOTRLevelData.clientside_thisServer_fellowshipMaxSize;
   }

   public static boolean isEnchantingEnabled(World world) {
      return !world.field_72995_K ? enchantingVanilla : LOTRLevelData.clientside_thisServer_enchanting;
   }

   public static boolean isLOTREnchantingEnabled(World world) {
      return !world.field_72995_K ? enchantingLOTR : LOTRLevelData.clientside_thisServer_enchantingLOTR;
   }

   public static boolean areStrictFactionTitleRequirementsEnabled(World world) {
      return !world.field_72995_K ? strictFactionTitleRequirements : LOTRLevelData.clientside_thisServer_strictFactionTitleRequirements;
   }

   public static int getCustomWaypointMinY(World world) {
      return !world.field_72995_K ? customWaypointMinY : LOTRLevelData.clientside_thisServer_customWaypointMinY;
   }
}
