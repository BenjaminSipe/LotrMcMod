...
public class IsengardSnagaArcherEntity extends IsengardSnagaEntity {
   private static final SpawnEquipmentTable DAGGERS;

   public IsengardSnagaArcherEntity(EntityType type, World w) {
      super(type, w);
   ...
   static {
      DAGGERS = SpawnEquipmentTable.of(LOTRItems.STONE_DAGGER, LOTRItems.IRON_DAGGER, LOTRItems.BRONZE_DAGGER, LOTRItems.URUK_DAGGER);
   }
}
