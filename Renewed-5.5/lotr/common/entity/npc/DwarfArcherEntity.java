...
public class DwarfArcherEntity extends DwarfWarriorEntity {
   public DwarfArcherEntity(EntityType type, World w) {
      super(type, w);
   ...
   public ILivingEntityData func_213386_a(IServerWorld sw, DifficultyInstance diff, SpawnReason reason, ILivingEntityData spawnData, CompoundNBT dataTag) {
      ...
      this.npcItemsInv.setMeleeWeapon(new ItemStack((IItemProvider)LOTRItems.DWARVEN_DAGGER.get()));
