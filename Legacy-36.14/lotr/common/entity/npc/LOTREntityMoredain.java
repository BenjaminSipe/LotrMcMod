...
public class LOTREntityMoredain extends LOTREntityMan {
   public LOTREntityMoredain(World world) {
      ...
      this.field_70714_bg.func_75776_a(6, new LOTREntityAIEat(this, LOTRFoods.MOREDAIN, 8000));
      this.field_70714_bg.func_75776_a(6, new LOTREntityAIDrink(this, LOTRFoods.MOREDAIN_DRINK, 8000));
   ...
   public LOTRNPCMount createMountToRide() {
      return new LOTREntityZebra(this.field_70170_p);
   }
   ...
   public String getNPCFormattedName(String npcName, String entityName) {
      return this.getClass() == LOTREntityMoredain.class ? StatCollector.func_74837_a("entity.lotr.Moredain.entityName", new Object[]{npcName}) : super.getNPCFormattedName(npcName, entityName);
   }
   ...
   public boolean func_70601_bi() {
      if (super.func_70601_bi()) {
         ...
         if (j > 62 && (block == Blocks.field_150349_c || block == Blocks.field_150354_m)) {
            return true;
         }
      }
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      if (this.isFriendlyAndAligned(entityplayer)) {
         return this.hiredNPCInfo.getHiringPlayer() == entityplayer ? "moredain/moredain/hired" : "moredain/moredain/friendly";
      } else {
