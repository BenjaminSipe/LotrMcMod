...
public class LOTRWorldGenBreeOffice extends LOTRWorldGenBreeStructure {
   ...
   public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
      ...
      this.setBlockAndMetadata(world, 5, 6, 2, getRandomPieBlock(random), 0);
      this.setBlockAndMetadata(world, -3, 6, 2, getRandomPieBlock(random), 0);
      ...
      this.setBlockAndMetadata(world, -5, 5, 1, Blocks.field_150324_C, 3);
      this.setBlockAndMetadata(world, -6, 5, 1, Blocks.field_150324_C, 11);
      this.setBlockAndMetadata(world, -5, 5, 2, Blocks.field_150324_C, 3);
      this.setBlockAndMetadata(world, -6, 5, 2, Blocks.field_150324_C, 11);
      this.setBlockAndMetadata(world, -5, 9, 0, LOTRMod.strawBed, 3);
      this.setBlockAndMetadata(world, -6, 9, 0, LOTRMod.strawBed, 11);
      this.spawnItemFrame(world, 0, 2, 1, 2, new ItemStack(Items.field_151113_aN));
      ...
      this.placeSign(world, 0, 3, -8, Blocks.field_150444_as, 2, new String[]{"Sherriff", sherriffNameParts[0], sherriffNameParts[1], ""});
      return true;
   }
}
