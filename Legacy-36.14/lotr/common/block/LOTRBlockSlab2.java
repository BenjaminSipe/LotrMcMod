...
public class LOTRBlockSlab2 extends LOTRBlockSlabBase {
   ...
   public IIcon func_149691_a(int i, int j) {
      j &= 7;
      if (j == 0) {
         return LOTRMod.pillar.func_149691_a(i, 0);
      } else if (j == 1) {
         return LOTRMod.smoothStone.func_149691_a(i, 2);
      } else if (j == 2) {
         ...
         return LOTRMod.pillar.func_149691_a(i, 1);
      } else {
         return j == 7 ? LOTRMod.pillar.func_149691_a(i, 2) : super.func_149691_a(i, j);
      }
   }
