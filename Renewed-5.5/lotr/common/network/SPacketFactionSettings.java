...
public class SPacketFactionSettings {
   ...
   public static void handle(SPacketFactionSettings packet, Supplier context) {
      FactionSettingsManager.clientInstance().loadClientFactionsFromServer(Minecraft.func_71410_x().func_195551_G(), packet.factionSettings);
