...
public class LOTRBlockSlab3 extends LOTRBlockSlabBase {
   ...
   public IIcon func_149691_a(int i, int j) {
      j &= 7;
      if (j == 0) {
         return LOTRMod.smoothStone.func_149691_a(i, 3);
      } else if (j == 1) {
         return LOTRMod.brick.func_149691_a(i, 14);
      } else if (j == 2) {
         return LOTRMod.pillar.func_149691_a(i, 3);
      } else if (j == 3) {
         return LOTRMod.brick2.func_149691_a(i, 0);
      } else if (j == 4) {
         return LOTRMod.brick2.func_149691_a(i, 1);
      } else if (j == 5) {
         return LOTRMod.smoothStone.func_149691_a(i, 4);
      } else if (j == 6) {
         return LOTRMod.brick2.func_149691_a(i, 2);
      } else {
         return j == 7 ? LOTRMod.pillar.func_149691_a(i, 4) : super.func_149691_a(i, j);
      }
   }
