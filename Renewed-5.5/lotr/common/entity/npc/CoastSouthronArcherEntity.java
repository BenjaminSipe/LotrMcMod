...
public class CoastSouthronArcherEntity extends CoastSouthronWarriorEntity {
   private static final SpawnEquipmentTable DAGGERS;

   public CoastSouthronArcherEntity(EntityType type, World w) {
      super(type, w);
   ...
   static {
      DAGGERS = SpawnEquipmentTable.of(LOTRItems.UMBAR_DAGGER, LOTRItems.HARAD_DAGGER);
   }
}
