...
public class LOTREntityEasterlingBartender extends LOTREntityEasterling implements LOTRTradeable.Bartender {
   ...
   public void func_70628_a(boolean flag, int i) {
      ...
      for(int l = 0; l < drinks; ++l) {
         ItemStack drink = LOTRFoods.RHUN_DRINK.getRandomFood(this.field_70146_Z);
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      return this.isFriendlyAndAligned(entityplayer) ? "rhun/bartender/friendly" : "rhun/bartender/hostile";
   }
}
