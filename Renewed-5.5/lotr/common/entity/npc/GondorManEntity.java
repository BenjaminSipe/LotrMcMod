...
public class GondorManEntity extends ManEntity {
   ...
   protected ITextComponent formatNPCName(ITextComponent npcName, ITextComponent typeName) {
      return new TranslationTextComponent("entityname.lotr.gondor_man", new Object[]{npcName, typeName});
   }
   ...
   static {
      WEAPONS = SpawnEquipmentTable.of(LOTRItems.GONDOR_DAGGER, LOTRItems.IRON_DAGGER, LOTRItems.BRONZE_DAGGER, Items.field_151036_c, LOTRItems.BRONZE_AXE, Items.field_151049_t);
   }
}
