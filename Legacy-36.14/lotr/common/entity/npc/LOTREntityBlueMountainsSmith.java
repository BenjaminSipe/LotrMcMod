...
public class LOTREntityBlueMountainsSmith extends LOTREntityBlueDwarf implements LOTRTradeable.Smith {
   ...
   protected void func_70628_a(boolean flag, int i) {
      ...
      this.func_145779_a(LOTRMod.blueDwarfSteel, 1 + this.field_70146_Z.nextInt(3) + this.field_70146_Z.nextInt(i + 1));
   }
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      if (this.isFriendlyAndAligned(entityplayer)) {
         return this.canTradeWith(entityplayer) ? "blueDwarf/smith/friendly" : "blueDwarf/smith/neutral";
      } else {
