...
public class LOTRWorldGenDorwinionTent extends LOTRWorldGenStructureBase2 {
   ...
   public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
      ...
      for(i1 = -2; i1 <= 2; ++i1) {
         if (i1 % 2 == 0) {
            this.setBlockAndMetadata(world, -2, 3, i1, this.clay1StairBlock, 1);
            this.setBlockAndMetadata(world, 2, 3, i1, this.clay1StairBlock, 0);
            this.setBlockAndMetadata(world, -1, 3, i1, this.clay1StairBlock, 4);
            this.setBlockAndMetadata(world, 1, 3, i1, this.clay1StairBlock, 5);
            this.setBlockAndMetadata(world, -1, 4, i1, this.clay1StairBlock, 1);
            this.setBlockAndMetadata(world, 1, 4, i1, this.clay1StairBlock, 0);
            this.setBlockAndMetadata(world, 0, 4, i1, this.clay1Block, this.clay1Meta);
            this.setBlockAndMetadata(world, 0, 5, i1, this.clay1SlabBlock, this.clay1SlabMeta);
         } else {
            this.setBlockAndMetadata(world, -2, 3, i1, this.clay2StairBlock, 1);
            this.setBlockAndMetadata(world, 2, 3, i1, this.clay2StairBlock, 0);
            this.setBlockAndMetadata(world, -1, 3, i1, this.clay2StairBlock, 4);
            this.setBlockAndMetadata(world, 1, 3, i1, this.clay2StairBlock, 5);
            this.setBlockAndMetadata(world, -1, 4, i1, this.clay2StairBlock, 1);
            this.setBlockAndMetadata(world, 1, 4, i1, this.clay2StairBlock, 0);
            this.setBlockAndMetadata(world, 0, 4, i1, this.clay2Block, this.clay2Meta);
            this.setBlockAndMetadata(world, 0, 5, i1, this.clay2SlabBlock, this.clay2SlabMeta);
         }
      }
