...
public class LOTRBlockSapling8 extends LOTRBlockSaplingBase {
   public LOTRBlockSapling8() {
      this.setSaplingNames(new String[]{"plum", "redwood", "pomegranate", "palm"});
   }
   ...
   public void growTree(World world, int i, int j, int k, Random random) {
      ...
      if (meta == 1) {
         ...
         int[] tree2x2;
         if (treeGen == null) {
            tree2x2 = LOTRBlockSaplingBase.findSaplingSquare(world, i, j, k, this, meta, -1, 2, -2, 1);
            if (tree2x2 != null) {
         ...
         if (treeGen == null) {
            tree2x2 = LOTRBlockSaplingBase.findPartyTree(world, i, j, k, this, meta);
            if (tree2x2 != null) {
         ...
         if (treeGen == null) {
            tree2x2 = LOTRBlockSaplingBase.findSaplingSquare(world, i, j, k, this, meta, 0, 1, -1, 0);
            if (tree2x2 != null) {
