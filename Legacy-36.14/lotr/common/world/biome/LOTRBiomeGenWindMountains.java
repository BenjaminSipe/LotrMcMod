...
public class LOTRBiomeGenWindMountains extends LOTRBiome {
         ...
         if (block == Blocks.field_150348_b) {
            if (random.nextInt(6) == 0) {
               ...
               for(int j1 = j; j1 > j - h && j1 > 0; --j1) {
                  ...
                  if (blocks[indexH] == Blocks.field_150348_b) {
                     blocks[indexH] = Blocks.field_150406_ce;
                     meta[indexH] = 9;
                  }
               }
            } else if (random.nextInt(16) == 0) {
               blocks[index] = Blocks.field_150435_aG;
               meta[index] = 0;
            }
         }
      }
   ...
   public void func_76728_a(World world, Random random, int i, int k) {
      ...
      for(int l = 0; l < 3; ++l) {
         ...
         int j1 = MathHelper.func_76136_a(random, 70, 160);
         int k1 = k + random.nextInt(16) + 8;
         (new LOTRWorldGenMountainsideBush(LOTRMod.leaves5, 0)).func_76484_a(world, random, i1, j1, k1);
      }
