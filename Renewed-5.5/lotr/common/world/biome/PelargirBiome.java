...
public class PelargirBiome extends BaseGondorBiome {
   public PelargirBiome(boolean major) {
      super((new Builder()).func_205415_a(RainType.RAIN).func_205419_a(Category.PLAINS).func_205421_a(0.08F).func_205420_b(0.2F).func_205414_c(1.0F).func_205417_d(1.0F), major);
   }
