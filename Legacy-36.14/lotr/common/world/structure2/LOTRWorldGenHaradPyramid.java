...
public class LOTRWorldGenHaradPyramid extends LOTRWorldGenStructureBase2 {
   ...
   public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
      ...
      if (this.restrictions) {
         for(int i1 = -pyramidRadius; i1 <= pyramidRadius; ++i1) {
            for(int k1 = -pyramidRadius; k1 <= pyramidRadius; ++k1) {
               ...
               if (!this.isSurface(world, i1, j1, k1) && block != Blocks.field_150348_b && block != Blocks.field_150322_A && block != LOTRMod.redSandstone) {
                  return false;
               }
            }
         }
      ...
      this.addBlockMetaAliasOption("BRICK_MAYBE", 4, Blocks.field_150350_a, 0);
      ...
      this.addBlockMetaAliasOption("TUNNEL", 5, Blocks.field_150354_m, 0);
      this.addBlockMetaAliasOption("TUNNEL", 5, Blocks.field_150350_a, 0);
      this.addBlockMetaAliasOption("ROOF", 4, Blocks.field_150354_m, 1);
   ...
   private void placePyramidChest(World world, Random random, int i, int j, int k, int meta, boolean trap) {
      int amount = MathHelper.func_76136_a(random, 3, 5);
      if (trap) {
