...
public class LOTRDispenseSpear extends BehaviorDefaultDispenseItem {
   public ItemStack func_82487_b(IBlockSource dispenser, ItemStack itemstack) {
      ...
      LOTREntitySpear spear = new LOTREntitySpear(world, itemstack.func_77946_l(), iposition.func_82615_a(), iposition.func_82617_b(), iposition.func_82616_c());
      spear.func_70186_c((double)enumfacing.func_82601_c(), (double)((float)enumfacing.func_96559_d() + 0.1F), (double)enumfacing.func_82599_e(), 1.1F, 6.0F);
