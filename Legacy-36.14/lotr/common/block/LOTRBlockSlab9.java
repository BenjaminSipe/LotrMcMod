...
public class LOTRBlockSlab9 extends LOTRBlockSlabBase {
   ...
   public IIcon func_149691_a(int i, int j) {
      ...
      if (j == 0) {
         ...
         return LOTRMod.pillar2.func_149691_a(i, 1);
      } else if (j == 2) {
         return LOTRMod.pillar2.func_149691_a(i, 2);
      } else if (j == 3) {
         return LOTRMod.pillar2.func_149691_a(i, 3);
      } else if (j == 4) {
         return LOTRMod.pillar2.func_149691_a(i, 4);
      } else if (j == 5) {
         return LOTRMod.brick5.func_149691_a(i, 0);
      } else if (j == 6) {
         return LOTRMod.brick5.func_149691_a(i, 1);
      } else {
         return j == 7 ? LOTRMod.brick5.func_149691_a(i, 2) : super.func_149691_a(i, j);
      }
   }
