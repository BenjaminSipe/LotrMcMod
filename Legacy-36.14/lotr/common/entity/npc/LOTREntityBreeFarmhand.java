...
public class LOTREntityBreeFarmhand extends LOTREntityBreeMan implements LOTRFarmhand {
   ...
   protected void addBreeHiringAI(int prio) {
      ...
      this.field_70714_bg.func_75776_a(prio, new LOTREntityAIFarm(this, 1.0D, 1.0F));
   }
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      return this.hiredNPCInfo.getHiringPlayer() == entityplayer ? "bree/farmhand/hired" : super.getSpeechBank(entityplayer);
   }
}
