...
public class LOTRBlockSlab12 extends LOTRBlockSlabBase {
   ...
   public IIcon func_149691_a(int i, int j) {
      j &= 7;
      if (j == 0) {
         return LOTRMod.brick5.func_149691_a(i, 11);
      } else if (j == 1) {
         ...
         return LOTRMod.pillar2.func_149691_a(i, 8);
      } else if (j == 5) {
         return LOTRMod.brick6.func_149691_a(i, 1);
      } else if (j == 6) {
         return LOTRMod.pillar2.func_149691_a(i, 9);
      } else {
         return j == 7 ? LOTRMod.brick6.func_149691_a(i, 10) : super.func_149691_a(i, j);
      }
   }
