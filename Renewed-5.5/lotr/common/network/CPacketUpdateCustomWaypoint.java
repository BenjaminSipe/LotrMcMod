      ...
      if (waypoint == null) {
         ...
         if (waypointName.isEmpty()) {
            ...
            if (marker == null) {
               ...
               if (ftData.updateCustomWaypoint(world, waypoint, waypointName, waypointLore, isPublic)) {
                  CustomWaypointStructureHandler.INSTANCE.updateWaypointStructure(player, waypoint);
                  LOTRUtil.sendMessage(player, new TranslationTextComponent("chat.lotr.cwp.update", new Object[]{waypointName}));
