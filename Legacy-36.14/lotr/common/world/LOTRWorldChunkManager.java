...
public class LOTRWorldChunkManager extends WorldChunkManager {
   ...
   private Map villageCacheMap = new HashMap();
   private Map structureCacheMap = new HashMap();
   ...
   private void setupGenLayers() {
      long seed = this.worldObj.func_72905_C() + 1954L;
      this.chunkGenLayers = LOTRGenLayerWorld.createWorld(this.lotrDimension, this.worldObj.func_72912_H().func_76067_t());
   ...
   public float[] func_76936_a(float[] rainfall, int i, int k, int xSize, int zSize) {
      ...
      for(int l = 0; l < xSize * zSize; ++l) {
         int biomeID = ints[l];
         float f = (float)this.lotrDimension.biomeList[biomeID].func_76744_g() / 65536.0F;
         if (f > 1.0F) {
            f = 1.0F;
         }
   ...
   public float func_76939_a(float f, int height) {
      return this.worldObj.field_72995_K && LOTRMod.isChristmas() ? 0.0F : f;
   }
      ...
      if (biomeSource != null) {
         ...
         for(int k1 = 0; k1 < zSize; ++k1) {
            for(int i1 = 0; i1 < xSize; ++i1) {
               ...
               biomes[index] = this.worldObj.func_72807_a(i + i1, k + k1);
            }
         }
      }
   ...
   public LOTRBiomeVariant getBiomeVariantAt(int i, int k) {
      Chunk chunk = this.worldObj.func_72938_d(i, k);
      if (chunk != null) {
      ...
      return !this.worldObj.field_72995_K ? this.getBiomeVariants((LOTRBiomeVariant[])null, i, k, 1, 1)[0] : LOTRBiomeVariant.STANDARD;
   }
   ...
   public boolean areVariantsSuitableVillage(int i, int k, int range, boolean requireFlat) {
      ...
      int i3 = i2 - i1 + 1;
      int k3 = k2 - k1 + 1;
      BiomeGenBase[] biomes = this.func_76937_a((BiomeGenBase[])null, i1, k1, i3, k3);
