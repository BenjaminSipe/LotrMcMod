...
public class EriadorBiome extends LOTRBiomeBase {
   public EriadorBiome(boolean major) {
      this((new Builder()).func_205415_a(RainType.RAIN).func_205419_a(Category.PLAINS).func_205421_a(0.1F).func_205420_b(0.4F).func_205414_c(0.8F).func_205417_d(0.8F), major);
   }
   ...
   public static class ErynVorn extends EriadorBiome {
      public ErynVorn(boolean major) {
         super((new Builder()).func_205415_a(RainType.RAIN).func_205419_a(Category.FOREST).func_205421_a(0.1F).func_205420_b(0.4F).func_205414_c(0.8F).func_205417_d(0.9F), major);
      }
   ...
   public static class Minhiriath extends EriadorBiome {
      public Minhiriath(boolean major) {
         super((new Builder()).func_205415_a(RainType.RAIN).func_205419_a(Category.PLAINS).func_205421_a(0.1F).func_205420_b(0.3F).func_205414_c(0.7F).func_205417_d(0.5F), major);
      }
   ...
   public static class EvendimHills extends EriadorBiome {
      public EvendimHills(boolean major) {
         super((new Builder()).func_205415_a(RainType.RAIN).func_205419_a(Category.EXTREME_HILLS).func_205421_a(0.6F).func_205420_b(1.2F).func_205414_c(0.7F).func_205417_d(0.8F), major);
      }
      ...
      protected void addVegetation(net.minecraft.world.biome.BiomeGenerationSettings.Builder builder) {
         ...
         LOTRBiomeFeatures.addAthelasChance(builder);
         LOTRBiomeFeatures.addTundraBushesFreq(builder, 2, (new WeightedBlockStateProvider()).func_227407_a_((BlockState)((Block)LOTRBlocks.PINE_LEAVES.get()).func_176223_P().func_206870_a(LeavesBlock.field_208495_b, true), 1), 32);
      }
   ...
   public static class Downs extends EriadorBiome {
      public Downs(boolean major) {
         super((new Builder()).func_205415_a(RainType.RAIN).func_205419_a(Category.PLAINS).func_205421_a(0.7F).func_205420_b(0.6F).func_205414_c(0.6F).func_205417_d(0.7F), major);
      }
