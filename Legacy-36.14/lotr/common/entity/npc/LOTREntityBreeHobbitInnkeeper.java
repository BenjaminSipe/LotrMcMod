...
public class LOTREntityBreeHobbitInnkeeper extends LOTREntityBreeHobbit implements LOTRTradeable.Bartender {
   ...
   public void dropHobbitItems(boolean flag, int i) {
      ...
      for(int k = 0; k < j; ++k) {
         ...
         case 1:
         case 2:
            Item food = LOTRFoods.BREE.getRandomFood(this.field_70146_Z).func_77973_b();
         ...
         case 5:
            ...
            break;
         case 6:
            Item drink = LOTRFoods.BREE.getRandomFood(this.field_70146_Z).func_77973_b();
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      return this.isFriendlyAndAligned(entityplayer) ? "bree/innkeeper/hobbit/friendly" : "bree/innkeeper/hobbit/hostile";
   }
}
