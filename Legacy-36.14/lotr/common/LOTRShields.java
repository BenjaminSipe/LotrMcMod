...
public enum LOTRShields {
   ...
   HARAD_CONTEST(new String[]{"05d987d8-7e3d-44b2-a170-234efe19f907", "79be2597-856d-4c92-9493-bbc8dfc45970", "2c862690-b9d4-42de-a1b9-cb2200b75e72"}),
   ...
   private LOTRShields(LOTRFaction faction) {
      this(LOTRShields.ShieldType.ALIGNMENT, false);
      this.alignmentFaction = faction;
   }

   private LOTRShields() {
      this(LOTRShields.ShieldType.ACHIEVABLE, false);
   }
   ...
   private LOTRShields(boolean hidden, String... players) {
      this(LOTRShields.ShieldType.EXCLUSIVE, hidden, players);
   }

   private LOTRShields(LOTRShields.ShieldType type, boolean hidden, String... players) {
   ...
   public String getShieldName() {
      return StatCollector.func_74838_a("lotr.shields." + this.name() + ".name");
   }

   public String getShieldDesc() {
      return StatCollector.func_74838_a("lotr.shields." + this.name() + ".desc");
   }
   ...
   public boolean canPlayerWear(EntityPlayer entityplayer) {
      ...
      } else if (this == DEFEAT_MALLORN_ENT) {
         return LOTRLevelData.getData(entityplayer).hasAchievement(LOTRAchievement.killMallornEnt);
      } else {
         if (this.shieldType == LOTRShields.ShieldType.EXCLUSIVE) {
            UUID[] var2 = this.exclusiveUUIDs;
   ...
   public static enum ShieldType {
      ...
      public String getDisplayName() {
         return StatCollector.func_74838_a("lotr.shields.category." + this.name());
      }
   }
}
