...
public class TrollshawsBiome extends LOTRBiomeBase {
   public TrollshawsBiome(boolean major) {
      super((new Builder()).func_205415_a(RainType.RAIN).func_205419_a(Category.FOREST).func_205421_a(0.15F).func_205420_b(0.9F).func_205414_c(0.6F).func_205417_d(0.8F), major);
   }
