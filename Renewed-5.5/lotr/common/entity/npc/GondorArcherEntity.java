...
public class GondorArcherEntity extends GondorSoldierEntity {
   public GondorArcherEntity(EntityType type, World w) {
      super(type, w);
   ...
   public ILivingEntityData func_213386_a(IServerWorld sw, DifficultyInstance diff, SpawnReason reason, ILivingEntityData spawnData, CompoundNBT dataTag) {
      ...
      this.npcItemsInv.setMeleeWeapon(new ItemStack((IItemProvider)LOTRItems.GONDOR_DAGGER.get()));
