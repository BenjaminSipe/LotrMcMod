...
public class UmbarSoldierEntity extends UmbarManEntity {
   ...
   public static MutableAttribute regAttrs() {
      return UmbarManEntity.regAttrs().func_233815_a_((Attribute)LOTRAttributes.NPC_RANGED_INACCURACY.get(), 0.75D);
   }
   ...
   public ILivingEntityData func_213386_a(IServerWorld sw, DifficultyInstance diff, SpawnReason reason, ILivingEntityData spawnData, CompoundNBT dataTag) {
      ...
      this.func_184201_a(EquipmentSlotType.FEET, new ItemStack((IItemProvider)LOTRItems.UMBAR_BOOTS.get()));
      this.func_184201_a(EquipmentSlotType.LEGS, new ItemStack((IItemProvider)LOTRItems.UMBAR_LEGGINGS.get()));
      this.func_184201_a(EquipmentSlotType.CHEST, new ItemStack((IItemProvider)LOTRItems.UMBAR_CHESTPLATE.get()));
      if (this.field_70146_Z.nextInt(10) != 0) {
         this.func_184201_a(EquipmentSlotType.HEAD, new ItemStack((IItemProvider)LOTRItems.UMBAR_HELMET.get()));
      }

      this.func_184201_a(EquipmentSlotType.OFFHAND, new ItemStack((IItemProvider)LOTRItems.UMBAR_SHIELD.get()));
      return spawnData;
   }
