...
public class LOTREntityNearHaradrimWarrior extends LOTREntityNearHaradrim {
   ...
   public IEntityLivingData func_110161_a(IEntityLivingData data) {
      ...
      if (this.field_70146_Z.nextInt(10) == 0) {
         ...
         this.func_70062_b(4, new ItemStack(LOTRMod.helmetNearHarad));
      }
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      if (this.isFriendlyAndAligned(entityplayer)) {
         return this.hiredNPCInfo.getHiringPlayer() == entityplayer ? "nearHarad/coast/warrior/hired" : "nearHarad/coast/warrior/friendly";
      } else {
