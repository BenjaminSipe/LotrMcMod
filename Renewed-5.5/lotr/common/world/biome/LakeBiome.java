...
public class LakeBiome extends LOTRBiomeBase {
   public LakeBiome(boolean major) {
      super((new Builder()).func_205415_a(RainType.RAIN).func_205419_a(Category.RIVER).func_205421_a(-0.9F).func_205420_b(0.15F).func_205414_c(0.5F).func_205417_d(0.5F), major);
   }
