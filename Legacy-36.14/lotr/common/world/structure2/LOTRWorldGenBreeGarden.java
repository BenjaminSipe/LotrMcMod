...
public class LOTRWorldGenBreeGarden extends LOTRWorldGenBreeStructure {
   ...
   public boolean generateWithSetRotation(World world, Random random, int i, int j, int k, int rotation) {
      ...
      this.addBlockMetaAliasOption("LEAF", 1, Blocks.field_150362_t, 4);
      ...
      this.addBlockMetaAliasOption("PATH", 14, Blocks.field_150349_c, 0);
      this.addBlockMetaAliasOption("PATH", 3, Blocks.field_150347_e, 0);
      this.addBlockMetaAliasOption("PATH", 3, Blocks.field_150347_e, 1);
      ...
      for(i1 = -5; i1 <= 5; ++i1) {
         for(k1 = -3; k1 <= 2; ++k1) {
            ...
            if (below == Blocks.field_150349_c && this.isAir(world, i1, j1, k1) && random.nextInt(5) == 0) {
