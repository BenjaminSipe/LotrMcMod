...
public class LOTREntityUmbarBartender extends LOTREntityUmbarian implements LOTRTradeable.Bartender {
   ...
   public void func_70628_a(boolean flag, int i) {
      ...
      for(int l = 0; l < drinks; ++l) {
         ItemStack drink = LOTRFoods.SOUTHRON_DRINK.getRandomFood(this.field_70146_Z);
   ...
   public String getSpeechBank(EntityPlayer entityplayer) {
      return this.isFriendlyAndAligned(entityplayer) ? "nearHarad/umbar/bartender/friendly" : "nearHarad/umbar/bartender/hostile";
   }
}
