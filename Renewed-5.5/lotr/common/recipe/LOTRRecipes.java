...
public class LOTRRecipes {
   ...
   public static final RegistryObject FACTION_SHAPED;
   public static final RegistryObject FACTION_SHAPELESS;
   public static final RegistryObject VESSEL_DRINK_SHAPELESS;
   public static final RegistryObject CRAFTING_SPECIAL_SMOKING_PIPE_COLORING;
   public static final RegistryObject CRAFTING_SPECIAL_POUCH;
   public static final RegistryObject ALLOY_SERIALIZER;
   public static final RegistryObject DWARVEN_FORGE_SERIALIZER;
   public static final RegistryObject DWARVEN_FORGE_ALLOY_SERIALIZER;
   public static final RegistryObject ELVEN_FORGE_SERIALIZER;
   public static final RegistryObject ELVEN_FORGE_ALLOY_SERIALIZER;
   public static final RegistryObject ORC_FORGE_SERIALIZER;
   public static final RegistryObject ORC_FORGE_ALLOY_SERIALIZER;
   public static final RegistryObject HOBBIT_OVEN_SERIALIZER;
   public static final RegistryObject HOBBIT_OVEN_ALLOY_SERIALIZER;
   public static final RegistryObject DRINK_BREWING_SERIALIZER;
   ...
   private static FactionTableType registerFaction(String s, Supplier blockSup) {
      ResourceLocation res = new ResourceLocation("lotr", s);
      FactionTableType type = (FactionTableType)Registry.func_218322_a(Registry.field_218367_H, res, new FactionTableType(res, blockSup));
      ALL_INDIVIDUAL_FACTION_TYPES.add(type);
      return type;
   }

   private static MultiTableType registerMulti(String s, List types) {
      ResourceLocation res = new ResourceLocation("lotr", s);
      return (MultiTableType)Registry.func_218322_a(Registry.field_218367_H, res, new MultiTableType(res, types));
   }

   private static MultiTableType registerMulti(String s, FactionTableType... types) {
      return registerMulti(s, (List)ImmutableList.copyOf(types));
   }

   private static IRecipeType register(String key) {
      final ResourceLocation res = new ResourceLocation("lotr", key);
      return (IRecipeType)Registry.func_218322_a(Registry.field_218367_H, res, new IRecipeType() {
   ...
   public static String findRecipeTypeName(IRecipeType type) {
      return Registry.field_218367_H.func_177774_c(type).toString();
   }

   @Nullable
   public static IRecipeType findRecipeTypeByName(ResourceLocation id) {
      return (IRecipeType)Registry.field_218367_H.func_82594_a(id);
   }
   ...
   static {
      ...
      CRAFTING_SPECIAL_SMOKING_PIPE_COLORING = RECIPE_SERIALIZERS.register("crafting_special_smoking_pipe_coloring", () -> {
         return new SpecialRecipeSerializer(SmokingPipeColoringRecipe::new);
      });
      CRAFTING_SPECIAL_POUCH = RECIPE_SERIALIZERS.register("crafting_special_pouch", PouchRecipe.Serializer::new);
      ALLOY_SERIALIZER = RECIPE_SERIALIZERS.register("alloy_forge", () -> {
         return new AlloyForgeRecipeSerializer(AlloyForgeRecipe::new, 200);
      });
      DWARVEN_FORGE_SERIALIZER = RECIPE_SERIALIZERS.register("dwarven_forge", () -> {
         return new CookingRecipeSerializer(DwarvenForgeRecipe::new, 200);
      });
      DWARVEN_FORGE_ALLOY_SERIALIZER = RECIPE_SERIALIZERS.register("dwarven_forge_alloy", () -> {
         return new AlloyForgeRecipeSerializer(DwarvenForgeAlloyRecipe::new, 200);
      });
      ELVEN_FORGE_SERIALIZER = RECIPE_SERIALIZERS.register("elven_forge", () -> {
         return new CookingRecipeSerializer(ElvenForgeRecipe::new, 200);
      });
      ELVEN_FORGE_ALLOY_SERIALIZER = RECIPE_SERIALIZERS.register("elven_forge_alloy", () -> {
         return new AlloyForgeRecipeSerializer(ElvenForgeAlloyRecipe::new, 200);
      });
      ORC_FORGE_SERIALIZER = RECIPE_SERIALIZERS.register("orc_forge", () -> {
         return new CookingRecipeSerializer(OrcForgeRecipe::new, 200);
      });
      ORC_FORGE_ALLOY_SERIALIZER = RECIPE_SERIALIZERS.register("orc_forge_alloy", () -> {
         return new AlloyForgeRecipeSerializer(OrcForgeAlloyRecipe::new, 200);
      });
      HOBBIT_OVEN_SERIALIZER = RECIPE_SERIALIZERS.register("hobbit_oven", () -> {
         return new CookingRecipeSerializer(HobbitOvenRecipe::new, 200);
      });
      HOBBIT_OVEN_ALLOY_SERIALIZER = RECIPE_SERIALIZERS.register("hobbit_oven_alloy", () -> {
         return new AlloyForgeRecipeSerializer(HobbitOvenAlloyRecipe::new, 200);
      });
      DRINK_BREWING_SERIALIZER = RECIPE_SERIALIZERS.register("brewing", () -> {
         return new DrinkBrewingRecipeSerializer(12000);
      });
   }
}
